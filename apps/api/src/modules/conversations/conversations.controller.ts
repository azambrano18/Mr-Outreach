...
function parseListFilter(query: Record<string, string | undefined>): ConversationListFilter {
  return {
    ...
    responseOutcome: query.responseOutcome as ConversationListFilter['responseOutcome'],
    tagId: query.tagId,
    isUnread: query.unread === undefined ? undefined : query.unread === 'true',
    isSimulation: query.isSimulation === undefined ? undefined : query.isSimulation === 'true',
    search: query.search,
...
export class ConversationsController {
  ...
  async list(
    ...
    @Query('responseOutcome') responseOutcome?: string,
